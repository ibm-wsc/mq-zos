...
![Picture of MQ explorer SSL key store preferences](assets/certificates/cert2.png "Picture of MQ explorer SSL key store preferences")
...
![Picture of MQ explorer SSL CipherSpec settings](assets/certificates/cert3.png "Picture of SSL CipherSpec settings")
...
![Picture of MQ explorer SSL CipherSpec settings](assets/certificates/cert4.png "Picture of SSL CipherSpec settings")

10\. On the General window use the pull-down arrow to select TCP. Click Finish to continue.

![Picture of MQ explorer SSL CipherSpec settings](assets/certificates/cert5.png "Picture of SSL CipherSpec settings")
...
![Picture of Channel authentication records list](assets/certificates/cert6.png)
...
![Picture of Channel authentication record creation](assets/certificates/cert7.png)

13\. On the 'Match' part of the identity window, select the radio button by 'SSL/TLS Distinguished Name'. Click 'Next' to continue.

![Picture of Channel authentication record creation](assets/certificates/cert8.png)

14\. On the 'Matching the channels window', enter USER1.SSL.* in the area under Channel Profile. Press 'Next' to continue.

![Picture of Channel authentication record creation](assets/certificates/cert9.png)
...
![Picture of Channel authentication record rule](assets/certificates/cert10.png)
...
![Picture of Channel authentication record rule](assets/certificates/cert11.png)

17\. Click 'Finish' on the Summary window to complete the definition of this authentication rule. 

![Picture of Channel authentication record rule](assets/certificates/cert12.png)

18\. Next, create a new remote connection to queue manager ZQS1.

![Picture of new remote queue manager setup](assets/certificates/cert13.png)
...
![Picture of new remote queue manager setup](assets/certificates/cert14.png)
...
![Picture of new remote queue manager setup](assets/certificates/cert15.png)
